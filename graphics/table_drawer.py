...
from graphics.conf import OUTLINE_WIDTH, INLINE_WIDTH, SMALLEST_STRING
from graphics.conf import C_RED, C_GREEN, C_GREY
from graphics.conf import RED_TAGS, GREEN_TAGS, GREY_TAGS
